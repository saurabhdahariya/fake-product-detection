...
<div class="welcome">
    <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-center bg-light mx-auto" style="margin-top:100px; ">
            <img src="img/manufacturer.png" class="img-fluid" alt="">
            <a href="login.php" class="text-decoration-none btn btn-primary mt-4 mb-4 font-weight-bold" style="font-size:20px;">manufacturer login</a>
            </div>
        </div>
    </div>
</div>
